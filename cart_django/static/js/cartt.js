function add_cart(id, url_image, name, number, price, describe, producer, url_action) {
    url_success =  Number(id)  + ",'" + url_action + "'";
    if(Number(number) <= 0) {
        alert("The product is sold out");
    }
    else {
        str = 
        "<div class='position-fixed zindex-offcanvas top-0' style='z-index: 100;'>"
        +"<div class='mask d-flex align-items-center gradient-custom-3 vh-100 min-vw-100'>"
        +"    <div class='container'>"
